...
Constructs the model of a cubic building with:
    - 5 identical two-layer walls (isolation + béton)
    - 1 transparent wall =total surface of glass
    - air infiltration
...
Sc = 126.44
Si = Sc
l = 2.8                       # m length of the cubic room
Va = l*(Sc+Sg)                   # m³ volume of air
...
wall = {'Conductivity': [1.4, 0.027, 1.4],      # W/m.K
        ...
        'Specific heat': [880, 1450, 750],      # J/kg.K
        'Width': [0.2, 0.1, 0.04],
        'Surface': [Sc, Si, Sg],  # m²
